    ...
    <div className=" h-full lg:h-screen bg-img flex justify-center items-center mt-20">
      ...
      <div className="flex gap-5 flex-col items-center lg:flex-row container backdrop-blur-md shadow p-5 z-30">
        ...
        <div className="text-slate-200 flex flex-col gap-4 items-start">
          ...
          <div>
            <h1 className="text-xl font-bold tracking-wide mb-1">Synopsis</h1>
...
//     />
//   </div>
//   <div className="absolute py-2 lg:py-0 top-[11%] md:top-[15%] lg:top-[30%] left-[5%] md:left-[10%] lg:left-[2%] xl:left-[15%] 2xl:left-[20%] w-[90%] md:w-[80%] lg:w-[95%] xl:w-[70%] 2xl:w-[45%] flex items-center flex-col  lg:flex-row gap-2 backdrop-blur-md rounded shadow-md container ">
//     <img
//       src={`https://image.tmdb.org/t/p/original/${detail?.poster_path}`}
